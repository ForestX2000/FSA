...
public class MainActivity extends AppCompatActivity {
    ...
    private Button buttonTimer; // кнопка остановки секундомера
    ...
    protected void onCreate(Bundle savedInstanceState) { // создание жизненного цикла активности
        ...
        buttonTimer = findViewById(R.id.buttonTimer); // кнопка обработки
        ...
        buttonTimer.setOnClickListener(listener); // обработка нажатия кнопки
    }
        ...
        public void onClick(View view) { // при нажатии кнопки во view записывается значение кнопки
            ...
            switch (view.getId()) { // switch (значение выбранного ID кнопки)
                ...
                case R.id.buttonPause: // нажатие кнопки "Пауза"
                    ...
                    break;
                case R.id.buttonTimer: // нажатие кнопки "Стоп"
                    startTime = SystemClock.elapsedRealtime(); // Миллисекунды с момента загрузки (не считая времени, проведенного в глубоком сне)
                    handler.postDelayed(updateTimerThread,); // запуск потока с нулевой задержкой
                    break;
            }
        }
    };
